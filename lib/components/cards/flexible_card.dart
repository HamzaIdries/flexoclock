      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (flexibleTask.isCurrent && flexibleTask.hasStarted && flexibleTask.displayButtons)
              currentTaskChoices()
            else if (flexibleTask.isCurrent && !flexibleTask.hasStarted && flexibleTask.displayButtons)
